...
declare function onForgeEvent(name: "io.github.edwinmindcraft.calio.api.event.CalioDynamicRegistryEvent$Reload", handler: (event: Internal.CalioDynamicRegistryEvent$Reload) => void);
...
declare function onForgeEvent(name: "io.github.edwinmindcraft.calio.api.event.CalioDynamicRegistryEvent$Initialize", handler: (event: Internal.CalioDynamicRegistryEvent$Initialize) => void);
...
declare function onForgeEvent(name: "io.github.edwinmindcraft.calio.api.event.CalioDynamicRegistryEvent$LoadComplete", handler: (event: Internal.CalioDynamicRegistryEvent$LoadComplete) => void);
...
declare function onForgeEvent(name: "io.github.edwinmindcraft.calio.api.event.DynamicRegistrationEvent", handler: (event: Internal.DynamicRegistrationEvent<any>) => void);
...
declare function onForgeEvent(name: "limonblaze.originsclasses.common.event.ModifyCraftResultEvent", handler: (event: Internal.ModifyCraftResultEvent) => void);
...
declare function onForgeEvent(name: "io.github.apace100.apoli.integration.PowerLoadEvent$Pre", handler: (event: Internal.PowerLoadEvent$Pre) => void);
...
declare function onForgeEvent(name: "io.github.apace100.apoli.integration.PowerLoadEvent$Post", handler: (event: Internal.PowerLoadEvent$Post) => void);
...
declare function onForgeEvent(name: "io.github.apace100.apoli.integration.ModifyValueEvent", handler: (event: Internal.ModifyValueEvent) => void);
